...
// Set up headers to force download as PDF
header('Content-Type: application/pdf');
header('Content-Disposition: inline;filename="'.$filename.'_'.$dateNow.'.pdf"');
header('Cache-Control: max-age=0');

// Create PDF file and stream the output directly to the browser
