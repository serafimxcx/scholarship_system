<div class="row">
                ...
                <div class="col-lg-9">
                    <table width="100%">
                        <tr>
                            <td><h3><b>Personal Information</b></h3></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="slct_yearlevel" id="slct_yearlevel" class="form-control" disabled>
                                ...
                                <?php 
                                    $result = $conn->query("select * from tb_yearlevel");
                                    while($row=$result->fetch_assoc()){
                                        echo "<option value='$row[id]' ";
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <label>Address:</label>
                    <input type="text" name="txt_address" id="txt_address" class="form-control" value='<?php echo $address;?>' disabled>
                </div>
                <div class="col-lg-3">
