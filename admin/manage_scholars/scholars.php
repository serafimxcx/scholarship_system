...
<body>
    <div class="content_container">
        <h5 class="content_title">Scholars</h5><br>
        <div class="admin_container">
            <table style="float: right;">
                <tr>
                    ...
                    <td>
                        <button type="button" id="btn_print" class="btn btn-default" application_id='<?php echo $application_id?>'>Print</button>
                    </td>
                </tr>
            </table><br><br>
            <div class="row">
...
<script src="scholars_script.js"></script>
</html>