    ...
    <div class="modal" style="display:flex;">
        <div id="login_div">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <input type="text" id="txt_studentno" class="form-control">
                </div>
            </div>
            ...
            <br><br>
            <span id="btn_forgotpass">Forgot Password?</span><br><br>
            <span id="btn_register">Don't have an account? Register here.</span>
        </div>
    </div>
</body>
